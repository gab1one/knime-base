 ...
 */
public class BinaryObjectConcatenateOperator extends AggregationOperator {
    ...
    protected boolean computeInternal(final DataCell cell) {
        ...
        try (final var inStream = binaryData.openInputStream()) {
            IOUtils.copy(inStream, m_outputStream);
            return false;
    ...
    protected DataCell getResultInternal() {
        ...
        if (outputStream == null) {
            ...
            try {
                ...
                // cannot happen, short arrays always yield in-memory binary objects
    ...
    protected void resetInternal() {
        ...
        try (outputStream) {
            ...
            FileUtils.deleteQuietly(outputStream == null ? null : outputStream.getFile());
        }
    }
