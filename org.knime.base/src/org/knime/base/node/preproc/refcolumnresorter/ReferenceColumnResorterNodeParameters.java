...
class ReferenceColumnResorterNodeParameters implements NodeParameters {
    ...
    @Section(title = "Unspecified Strategy")
    interface UnspecifiedStrategySection {}
    ...
    @Layout(UnspecifiedStrategySection.class)
    ...
    static final class OrderColumnProvider implements StateProvider<String> {
        ...
        public String computeState(final NodeParametersInput parametersInput) throws StateComputationFailureException {
            if ((m_orderColumnSupplier.get() != null && !m_orderColumnSupplier.get().isEmpty())) {
                return m_orderColumnSupplier.get();
            }
            return ColumnSelectionUtil.getCompatibleColumnsOfFirstPort(parametersInput, StringValue.class).stream()
    ...
    static final class UnspecifiedStrategyPersistor implements NodeParametersPersistor<UnspecifiedStrategy> {
        ...
        public UnspecifiedStrategy load(final NodeSettingsRO settings) throws InvalidSettingsException {
            ...
            return switch (strategy) {
                ...
                default -> throw new InvalidSettingsException("Unknown strategy: " + strategy);
            };
        }
